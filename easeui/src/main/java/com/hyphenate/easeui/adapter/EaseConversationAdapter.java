...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
   ...
   //推送
            ...
            if(ext.containsKey("name")){
                Object n=    ext.get("name");
                if(n!=null) {
                    EaseUserUtils.setUserNick(n.toString(), holder.name);
//                    Log.e("ext-img",ext.get("img").toString());
                    Glide.with(getContext())
                            .load(Global.IMAGEPATH+ext.get("img").toString())
                ...
                //单聊
                Glide.with(getContext())
                        .load(Global.IMAGEPATH+"/"+Global.getNickByUUid(username).getPic())
                        .placeholder(R.drawable.ease_default_avatar)
                        .error(R.drawable.ease_default_avatar)
                        .into(holder.avatar);
//                Log.e("ivivivpath",Global.getNickByUUid(username).getPic());
                EaseUserUtils.setUserNick(Global.getNickByAll(username).getNname(), holder.name);
            }
