...
public class Fragment_News_3 extends BaseFragment<News> {

    public static Fragment_News_3 instance() {
        Fragment_News_3 view = new Fragment_News_3();
        return view;
    }

    public Fragment_News_3() {
