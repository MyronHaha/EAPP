...
public class DeleteRecycleView extends RecyclerView {
    ...
    public DeleteRecycleView(Context context) {
        this(context,null);
    }

    public DeleteRecycleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs , 0);
    }

    public DeleteRecycleView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if (status == CLOSE) {
                    ...
                    mDeleteView = (TextView) viewHolder.getView(R.id.item_delete);
