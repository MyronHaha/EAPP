package com.hyhscm.myron.eapp.activity.Im.db;
...
import com.hyhscm.myron.eapp.activity.Im.Constant;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(EAPPApplication.getInstance().getApplicationContext());
    }
