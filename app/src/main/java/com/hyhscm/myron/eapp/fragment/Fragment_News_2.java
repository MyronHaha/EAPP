...
public class Fragment_News_2 extends BaseFragment<News> {

    public static Fragment_News_2 instance() {
        Fragment_News_2 view = new Fragment_News_2();
        return view;
    }

    public Fragment_News_2() {
