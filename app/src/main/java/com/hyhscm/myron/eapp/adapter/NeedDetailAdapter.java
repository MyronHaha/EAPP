...
public class NeedDetailAdapter extends RecyclerView.Adapter<NeedDetailAdapter.MyViewHolder> {
    ...
    //适配器初始化
    public NeedDetailAdapter(Context context, List datas) {
        mContext = context;
        this.data = datas;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ).inflate(R.layout.item_liuyan, parent,
                false);
